...
namespace NixPDC
{
    class SeleniumMetodos
    {
        ...
        public static string retornarValuePorName(IWebDriver driver, string name)
        {
            var elemento = driver.FindElement(By.Name(name));
        ...
        public static void alternarAba(IWebDriver driver)
        {
